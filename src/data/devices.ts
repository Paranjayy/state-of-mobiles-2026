...
export const phones: Phone[] = [
  ...
  // ─── PREMIUM: ₹25,000–₹40,000 ───
  {
    ...
    image: "https://fdn2.gsmarena.com/vv/bigpic/oneplus-nord-6-5g.jpg",
    tags: ["5G", "Snapdragon 8s Gen 4", "100W", "5800mAh"],
    highlightTags: ["5G", "Flagship Chip", "100W"],
    category: "premium",
    type: "android",
    benchmarks: {
      antutu: 1850000,
    ...
    specs: {
      ...
      storage: 256,
      storageType: "UFS 4.0",
      camera: "50MP OIS main (IMX890) + 8MP UW",
      cameraMain: 50,
      cameraOIS: true,
      cameraAperture: "f/1.8",
      frontCamera: 16,
      ...
      weight: 200,
      thickness: 8.1,
      colors: ["Obsidian Black", "Glacier Silver", "Palm Green"],
      ipRating: "IP65",
    },
    verdict:
      "The cousin's dream phone. Flagship Snapdragon 8s Gen 4 chip under 30K is insane. 100W charging (full in 25 mins), LTPO AMOLED display, 256GB storage, clean OxygenOS. This is the phone that makes you question why anyone would spend more.",
    pickFor: "cousin",
    pickLabel: "★ Cousin's Pick",
    releaseDate: "2026-04",
    pros: [
      "Flagship Snapdragon 8s Gen 4 at this price",
      "100W charging — full in 25 min",
      "256GB base storage",
      "LTPO AMOLED 120Hz",
      "4 years of updates",
    ],
    cons: ["No telephoto lens", "No wireless charging", "Plastic frame"],
  },
  {
    id: "moto-edge-60-pro",
    brand: "Motorola",
